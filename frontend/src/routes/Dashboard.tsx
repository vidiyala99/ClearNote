  ...
  return (
    <div className="min-h-screen bg-slate-50 font-body">
      ...
      <main className="p-8 max-w-6xl mx-auto">
        ...
        ) : isSignedIn && visits.length === 0 ? (
             <div className="text-center py-20 text-slate-400">
               <p className="text-base font-medium text-slate-500 mb-1">No visits yet</p>
               <p className="text-sm">Record your first clinical session to get started.</p>
             </div>
        ) : (
