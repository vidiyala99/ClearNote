...
const brandPoints = [
  { icon: Mic,         text: "Record visits with patient consent captured automatically" },
  { icon: FileText,    text: "AI-powered transcription and summary generation" },
  { icon: ShieldCheck, text: "End-to-end encrypted, secure by design" },
];
    ...
    <div className="min-h-screen bg-slate-50 flex font-body">
      ...
      <div className="hidden lg:flex lg:w-[44%] xl:w-5/12 bg-gradient-to-br from-cyan-700 to-teal-800 flex-col justify-between p-12 flex-shrink-0 relative overflow-hidden">
        ...
        <div className="relative">
          <h2 className="font-heading text-3xl font-bold text-white leading-snug mb-8 tracking-tight">
            Start documenting smarter<br />in minutes.
          </h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-5 p-8">
        <SignUp 
          ...
          appearance={{
            elements: {
              formButtonPrimary: 'bg-cyan-700 hover:bg-cyan-800 text-white text-sm font-medium',
            }
          }} 
        />
        <Link
